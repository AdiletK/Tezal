...
create table raw_material (id int8 not null,image text, amount_in_block int4 not null, create_date timestamp not null, description varchar(255) not null, name varchar(255) not null, unit_id int8 not null, update_date timestamp, volume float4 not null, category_id int8, primary key (id));
